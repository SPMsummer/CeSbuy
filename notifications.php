            ...
            <div class="col-md-12">
             <?php
                foreach ($allnotif as $all) {
                          ...
                          echo "<li>
                            <a href='update_notif.php?id=".$all['id']."&post_id=".$all['post_id']."&convo_user=".$all['convo_user']."&type=".$all['type']."&notifNo=".$all['notifNo']."'><b>".$user_name.' </b>commented on a post. '.date('m/d/Y H:i A', strtotime($all['time_added']));
                          echo "</a></li>";
                         }
             ?>
               </div>
