          ...
          <div class="panel-body">
            ...
            <div class="row">
                ...
                <?php 
                  ...
                  {  
                    foreach ($post_data as $k) {                      
                      echo '<a href="view_post.php?post_id='.$k['post_id'].'"><button type="button" class="btn btn-default">View Post</button></a>';
                      echo '<a href="edit_post.php?post_id='.$k['post_id'].'"><button type="button" class="btn btn-default">Edit Post</button></a>';
                      echo '<a href="delete_post.php?post_id='.$k['post_id'].'"><button type="button" id='.$k['post_id'].' class="deleteBtn btn btn-default" onclick="">Mark as done</button></a>';
                      echo '<br />';
                      $image = $k['image_location'];
                      echo "<img src='$image'>".'<br />';
                      // $image = $k['image_location'].'<br />';
                      // echo "<img src='$image'>".'<br />';
                      echo 'Name: '.$k['name'].'<br />';
                      echo 'Price: '.$k['price'].'<br />';
                      echo 'Category: '.$k['category'].'<br />';
                      echo 'Description: '.$k['description'].'<br />';
                      echo '<br />';
